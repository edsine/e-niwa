...
!function (NioApp, $) {
  ...
  var profileBalance = {
    ...
    datasets: [{
      ...
      color: "#00923f",
      background: NioApp.hexRGB('#00923f', .3),
  ...
  var salesRevenue = {
    ...
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), "#00923f"],
  ...
  var activeSubscription = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), "#00923f"],
