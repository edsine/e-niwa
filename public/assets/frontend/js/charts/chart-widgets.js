...
!function (NioApp, $) {
  ...
  var analyticOvData = {
    ...
    datasets: [{
      ...
      color: "#00923f",
      dash: [0, 0],
      background: NioApp.hexRGB('#00923f', .15),
  ...
  var OrganicSearchData = {
    ...
    datasets: [{
      ...
      color: "#00923f",
      background: NioApp.hexRGB('#00923f', .25),
  ...
  var TrafficChannelDoughnutData = {
    ...
    datasets: [{
      borderColor: "#fff",
      background: ["#00923f", "#b8acff", "#ffa9ce", "#f9db7b"],
  ...
  var totalDeposit = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), NioApp.hexRGB("#00923f", .2), "#00923f"],
      // @v2.0
