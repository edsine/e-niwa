                ...
                <div class="row login-one-container h-100">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="login-one-start">
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-1">
                                    <p class="text-center text-muted mt-3 mb-3 font-14">
                                        {{ __('Enter you email address below') }}</p>
                            ...
                            <div class="form-2">
                                <p class="text-center text-muted mt-3 mb-3 font-14">
                                    {{ __('A verification code has been sent') }}</p>
                                <form method="get" class="digit-group mt-5" data-group-name="digits"
                                ...
                                <div class="login-one-inputs mt-3 text-center font-12 strong">
                                    <a href="#" class="text-primary"
                                        id="changeEmailAddress">{{ __('Change your email address') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
