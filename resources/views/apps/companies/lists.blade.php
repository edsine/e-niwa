...
@push('plugin-styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/ui-elements/pagination.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/jquery-ui/jquery-ui.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/apps/companies.css') }}">
@endpush
...
@push('plugin-scripts')
    ...
    <script src="{{ asset('assets/js/apps/companies.js') }}"></script>
@endpush
