...
<head>
    ...
    <style>
        ...
        .overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(rgba(0, 128, 0, 0.7), rgba(0, 128, 0, 0.3));
            /* Green overlay */
        }
...
<body>
    ...
    <div class="hero">
        <div class="slider active">
            <img src="{{ asset('assets/images/sliders/hero-slider1.jpeg') }}" alt="Slider 1">
            <div class="overlay"></div>
        </div>
        <div class="slider">
            <img src="{{ asset('assets/images/sliders/hero-slider2.jpeg') }}" alt="Slider 2">
            <div class="overlay"></div>
        </div>
        <div class="slider">
            <img src="{{ asset('assets/images/sliders/hero-slider3.jpeg') }}" alt="Slider 3">
            <div class="overlay"></div>
        </div>
        ...
        <div class="container-fluid">
            {{-- <div class="row">
                ...
                <div class="col-12 text-center mb-4">
                    <img style="height: 15vh" src="{{ asset('assets/img/niwa_logo_main-no_bg.png') }}" alt="Logo">
                </div>
            </div> --}}
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-center">
                    <div class="text-center w-100">
                        <img style="height: 15vh; margin-bottom: 10vh; margin-top: 30vh;" src="{{ asset('assets/img/niwa_logo_main.png') }}" alt="Logo">
                        <h1>Text Section</h1>
                        <p>This is the text section of the hero area.</p>
                    </div>
                </div>
                ...
                <div class="col-md-7  action-section">
                    <button class="show-buttons p-2 m-3 btn btn-info">Signup</button>
                    <button class="show-buttons p-2 m-3 btn btn-info">Register New Vessel</button>
                    <button class="show-buttons p-2 m-3 btn btn-info">Other Action Button</button>
                </div>
                ...
                <div id="form3" class="col-md-7 " style="display: none;">
                    <div class="card form-card col-md-10">
                        <div class="card-body">
                            <form class="nk-stepper stepper-init is-alter nk-stepper-s1" action="#"
                                id="stepper-create-project">
