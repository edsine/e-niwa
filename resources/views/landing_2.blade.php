            ...
            <div class="row">
                <div class="col-md-5 bg-dark is-dark p-5 d-flex justify-between flex-column text-center">
                    ...
                    <div class="pt-3 pb-3 text-block wide-xs mx-auto">
                        <h3 class="pt-3 pb-3 text-white">Let's Get Started</h3>
                        <p>Fill and Upload required documents: Easily upload digital copies of your vessel's registration documents and other necessary paperwork</p>
