...
@section('content')
    ...
    <div class="error-wrapper">
        <div class="col-md-6 error-left-section">
            <a class="navbar-brand" href="{{ url('/dashboard/dashboard2') }}">E-NIWA</a>
            <div class="error-left-content">
                <h1 class="mb-3 text-white">{{__('Under Maintenance')}}</h1>
                <p class="font-25 mb-5 text-white">{{__('We are currently working on making some improvements
                    to give you better user experience.')}}</p>
        ...
        <div class="col-md-6 error-right-section">
            <div class="error-menu">
                ...
                <a class="nav-link" target="_blank" href="{{ url('/pages/contact-us') }}">{{__('Maintenance')}}x</a>
            </div>
