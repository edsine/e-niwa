                        ...
                        <div class="widget">
                            <div class="widget-content widget-content-area">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="sitemap">
                                            <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold text-primary"><i class="mdi mdi-adjust mr-1"></i>{{__('E-NIWA Dashboard and Apps')}}</a>
                                                <ul>
                                        ...
                                        <ul class="sitemap">
                                            <li><a href="javascript: void(0);" class="text-uppercase font-weight-bold text-danger"><i class="mdi mdi-adjust mr-1"></i>{{__('Other')}}</a>
                                                <ul>
                                                    ...
                                                    <li><a href="http://E-NIWAweb.xyz" class="">{{__('Documentation')}}</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
