                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="single-result row">
                                            <div class="col-md-6 d-flex">
                                                ...
                                                <div class="info-container">
                                                    <h6>
                                                        <a href="#" class="text-primary strong">{{__('E-NIWA Admin - Codecanyon')}}</a>
                                                    </h6>
                                                    <p class="text-muted font-12">{{__('by E-NIWAWeb')}}</p>
                                        ...
                                        <div class="single-result">
                                            <h6 class="mb-1">
                                                <a href="#" class="text-primary">{{__('E-NIWA - Responsive Admin Template')}}</a>
                                            </h6>
                                        ...
                                        <div class="single-result">
                                            <h6 class="mb-1">
                                                <a href="#" class="text-primary">{{__('E-NIWA - Bootstrap Multipurpose Admin Template')}}</a>
                                            </h6>
                                            <div class="font-13 text-success mb-2 text-truncate">
                                                {{__('https://codecanyon.net/')}}
                                            </div>
                                        ...
                                        <div class="single-result">
                                            <h6 class="mb-1">
                                                <a href="#" class="text-primary">{{__('E-NIWA - HTML ADMIN TEMPLATE')}}</a>
                                            </h6>
                                            <div class="font-13 text-success mb-2 text-truncate">
                                                {{__('https://codecanyon.net/')}}
                                            </div>
